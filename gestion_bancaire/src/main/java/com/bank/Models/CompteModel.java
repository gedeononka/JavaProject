...
public class CompteModel {
    ...
    private Date date_ouverture; // Ajout du champ date_ouverture

    private ClientModel prop;
    private ArrayList<TransactionModel> listeTransactions;
    private float frais;

    // Constructeur avec date_ouverture
    public CompteModel(long num_c, TypeCompte type_c, float solde_c, long id_c, boolean etat, Date date_ouverture) {
        this.num_c = num_c;
        this.type_c = type_c;
    ...
    // Constructeur sans date_ouverture (si vous voulez garder une version sans)
    ...
    // Constructeur avec date_ouverture sans etat
    public CompteModel(long num_c, TypeCompte type_c, float solde_c, long id_c, Date date_ouverture) {
        this.num_c = num_c;
        this.type_c = type_c;
        this.solde_c = solde_c;
        this.id_c = id_c;
    ...
    // Constructeur sans date_ouverture et sans etat
    ...
    public Date getDate_ouverture() {
        return date_ouverture; // Getter pour date_ouverture
    }
    ...
    public void setDate_ouverture(Date date_ouverture) {
        this.date_ouverture = date_ouverture; // Setter pour date_ouverture
    }
}